...
import group.hashtag.projectelo.Activities.Handlers.UserHandler;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mDatabase.child(auth.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                group.hashtag.projectelo.Handlers.UserHandler user = dataSnapshot.getValue(group.hashtag.projectelo.Handlers.UserHandler.class);
